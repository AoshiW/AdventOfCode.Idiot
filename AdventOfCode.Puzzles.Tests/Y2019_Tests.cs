...
[TestClass]
public class Y2019_Tests
{
    //[TestMethod] public async Task Day01() => await Assert.TestAsync<Day01, int>(default, default);
    ...
    //[TestMethod] public async Task Day18() => await Assert.TestAsync<Day18, int>(default, default);
